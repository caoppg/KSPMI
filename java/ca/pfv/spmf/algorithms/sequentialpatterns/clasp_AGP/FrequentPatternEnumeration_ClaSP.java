 ...
 * Tin inserts:        
 */
if (isAvoidable) new_sequenceExtension = firstSequenceExtensions;             
 ...
 * Tin modifies:        
 */
List<Entry<Pattern, Trie>> entryList = new ArrayList<Entry<Pattern, Trie>>();            
                    ...
                    if (support == t.getSupport()) {
                        ...
                        if (pSize != prefixSize) {
                            ...
                            if (prefixSize < pSize) {
                            	...
                            	if (p.isSubpattern(abstractionCreator, prefix)) {
                                /*
