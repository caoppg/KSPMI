 ...
 */
public class FailurePredictionResults extends JFrame implements SWRLAPIView
{
    ...
    try {
      // Create an OWL ontology using the OWLAPI
    	OWLOntologyManager ontologyManager = OWLManager.createOWLOntologyManager();
    	  OWLOntology ontology = ontologyManager.loadOntologyFromOntologyDocument(new File("C:\\Users\\caoqs\\Desktop\\CyberneticsJournal2019\\Codes for expert rule integration\\inferredMFPO.owl"));
      ...
      // Create the view
      FailurePredictionResults sqwrlTab = new FailurePredictionResults(queryEngineModel, dialogManager);
  ...
  public FailurePredictionResults(@NonNull FileBackedSQWRLQueryEngineModel queryEngineModel,
  ...
  {
    System.err.println("Usage: " + FailurePredictionResults.class.getName() + " [ <owlFileName> ]");
    System.exit(1);
  }
}
