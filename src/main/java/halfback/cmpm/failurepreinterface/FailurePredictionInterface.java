 ...
 */
public class FailurePredictionInterface extends JFrame implements SWRLAPIView
{
  private static final long serialVersionUID = 1L;

  private static final String APPLICATION_NAME = "HALFBACK Prototype: the Failure Prediction Results Interface";
  private static final int APPLICATION_WINDOW_WIDTH = 1200;
  private static final int APPLICATION_WINDOW_HEIGHT = 780;
    ...
    try {
      // Create an OWL ontology using the OWLAPI
    	OWLOntologyManager ontologyManager = OWLManager.createOWLOntologyManager();
    	  OWLOntology ontology = ontologyManager.loadOntologyFromOntologyDocument(new File("Ontologies\\inferredMFPO.owl"));
      ...
      // Create the view
      FailurePredictionInterface sqwrlTab = new FailurePredictionInterface(queryEngineModel, dialogManager);
  ...
  public FailurePredictionInterface(@NonNull FileBackedSQWRLQueryEngineModel queryEngineModel,
  ...
  {
    System.err.println("Usage: " + FailurePredictionInterface.class.getName() + " [ <owlFileName> ]");
    System.exit(1);
  }
}
