...
public class ExtractFirstParetoFront {
	 ...
	 */
	public ExtractFirstParetoFront(String name, int dimensions) {
		fileName_ = name;
	...
	public static void main(String [] args) throws IOException {
		...
		ExtractFirstParetoFront epf = new ExtractFirstParetoFront(args[0], new Integer(args[1]));
