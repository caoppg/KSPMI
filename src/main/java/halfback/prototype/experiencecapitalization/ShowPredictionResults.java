...
public class ShowPredictionResults extends JFrame implements SWRLAPIView
{
  ...
  public static void main(@NonNull String[] args)
  {
    ...
    try {
      ...
      // Create the view
      ShowPredictionResults sqwrlTab = new ShowPredictionResults(queryEngineModel, dialogManager);
  ...
  public ShowPredictionResults(@NonNull FileBackedSQWRLQueryEngineModel queryEngineModel,
  ...
  {
    System.err.println("Usage: " + ShowPredictionResults.class.getName() + " [ <owlFileName> ]");
    System.exit(1);
  }
}
